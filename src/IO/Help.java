...
searches for a topic, and then displays the information associated with that topic.
Notice that it handles all I/O exceptions itself avoiding the need for calling
code to do so.
 */
class Help {
    ...
    boolean helpOn(String what) { //what - searched topic name
        int ch;
        String topic, info;
// Open the help file.
            ...
            do {
                ...
                if (ch == '#') {
                    ...
                    if (what.compareTo(topic) == 0) //found topic
                        do {
                            info = helpRdr.readLine(); //information in a found topic
